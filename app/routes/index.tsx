          ...
          <div className="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
            <div className="absolute inset-0">
              <img
                ...
                src="https://images4.alphacoders.com/106/1061827.png"
                alt="Shadow Monarch Face Setup By Jin-Woo"
              />
            ...
            <div className="lg:pb-18 relative px-4 pt-16 pb-8 sm:px-6 sm:pt-24 sm:pb-14 lg:px-8 lg:pt-32">
              ...
              <p className="mx-auto mt-6 max-w-lg text-center text-xl text-white sm:max-w-3xl">
                Save Your notes Online... Access them Globally, Anywhere anythime and save your Credentials... For a secure logbook online
              </p>
